...
internal struct SuperFilePickerModifier <T>: ViewModifier where T: Transferable & Sendable {
    ...
    func findAll() -> [URL] {
        (try? FileManager.default.contentsOfDirectory(at: Bundle.module.resourceURL.orFatalError("Bundle.module.resourceURL should not be nil"), includingPropertiesForKeys: [.contentTypeKey], options: [])) ?? []
            .filter { url in
